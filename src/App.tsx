...
export default function App() {
  ...
  const [preSelectedClass, setPreSelectedClass] = useState<string>('Class 11 (HSC College)');
  ...
  return (
    <div className="min-h-screen bg-[#faf8ff] text-[#131b2e] flex flex-col selection:bg-[#00a896] selection:text-white">
      {/* Top Navbar */}
      <Navbar
        language={language}
